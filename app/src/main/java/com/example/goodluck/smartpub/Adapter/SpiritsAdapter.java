...
public class SpiritsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{

    private Context context;
    private ArrayList<AbstractModel> itemList;

    public SpiritsAdapter(Context context, ArrayList<AbstractModel> itemList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.spirits_item_list,viewGroup,false);
